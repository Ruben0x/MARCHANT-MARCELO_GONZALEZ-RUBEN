...
public class OdontologoDaoH2 implements IDao<Odontologo> {
    ...
    public Odontologo guardar(Odontologo odontologo) {
        ...
        try{
            ...
            PreparedStatement preparedStatement = connection.prepareStatement(
                    "INSERT INTO ODONTOLOGOS (NUMERO_MATRICULA, NOMBRE, APELLIDO) VALUES (?,?,?)", Statement.RETURN_GENERATED_KEYS
            );
    ...
    public List<Odontologo> listarTodos() {
        ...
        try{
            ...
            while (resultSet.next()){
                Odontologo odontologo = crearObjetoOdontologos(resultSet);
    ...
    private Odontologo crearObjetoOdontologos(ResultSet resultSet) throws SQLException {
        ...
        return new Odontologo(
                resultSet.getInt("id"), resultSet.getInt("NUMERO_MATRICULA"), resultSet.getString("nombre"), resultSet.getString("apellido") );
    }
}
